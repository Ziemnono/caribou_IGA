...
class ElasticMaterial : public sofa::core::objectmodel::BaseObject {
    static constexpr auto Dimension = DataTypes::spatial_dimensions;
    using Coord = typename DataTypes::Coord;
    using Real  = typename Coord::value_type;
public:

    SOFA_CLASS(SOFA_TEMPLATE(ElasticMaterial, DataTypes), sofa::core::objectmodel::BaseObject);
    ...
    static std::string templateName(const ElasticMaterial<DataTypes>* = nullptr) {
        return DataTypes::Name();
    }

    /**
     * Check if we can create a ElasticMaterial<DataTypes> with the given
     ...
     */
    static bool canCreate(ElasticMaterial<DataTypes>* o, sofa::core::objectmodel::BaseContext* context, sofa::core::objectmodel::BaseObjectDescription* arg) {
