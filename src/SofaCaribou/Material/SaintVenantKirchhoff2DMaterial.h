...
class SaintVenantKirchhoff2DMaterial : public Hyperelastic2DMaterial<DataTypes> {
    static constexpr auto Dimension = DataTypes::spatial_dimensions;
    using Coord = typename DataTypes::Coord;
    using Real  = typename Coord::value_type;
public:
    SOFA_CLASS(SOFA_TEMPLATE(SaintVenantKirchhoff2DMaterial, DataTypes), SOFA_TEMPLATE(Hyperelastic2DMaterial, DataTypes));

    SaintVenantKirchhoff2DMaterial()
