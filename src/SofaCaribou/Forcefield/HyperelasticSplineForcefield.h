...
class HyperelasticSplineForcefield : public CaribouSplineForcefield<Element> {
public:
    SOFA_CLASS(SOFA_TEMPLATE(HyperelasticSplineForcefield, Element), SOFA_TEMPLATE(CaribouSplineForcefield, Element));
