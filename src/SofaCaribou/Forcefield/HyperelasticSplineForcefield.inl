...
HyperelasticSplineForcefield<Element>::HyperelasticSplineForcefield()
: d_material(initLink(
    "material",
...
template <typename Element>
void HyperelasticSplineForcefield<Element>::init()
{
...
template<typename Element>
void HyperelasticSplineForcefield<Element>::addForce(const sofa::core::MechanicalParams *mparams, sofa::core::MultiVecDerivId fId) {
    if (mparams) {
...
template <typename Element>
void HyperelasticSplineForcefield<Element>::addForce(
    ...
    const sofa::core::objectmodel::Data<VecDeriv>& d_v)
{
    ...
    sofa::helper::AdvancedTimer::stepBegin("HyperelasticSplineForcefield::addForce");
    ...
    sofa::helper::AdvancedTimer::stepEnd("HyperelasticSplineForcefield::addForce");
...
template <typename Element>
void HyperelasticSplineForcefield<Element>::addDForce(
    const sofa::core::MechanicalParams* mparams,
    ...
    const sofa::core::objectmodel::Data<VecDeriv>& d_dx)
{
    ...
    sofa::helper::AdvancedTimer::stepBegin("HyperelasticSplineForcefield::addDForce");
    ...
    SReal kFact, unsigned int & offset)
{
    ...
    sofa::helper::AdvancedTimer::stepBegin("HyperelasticSplineForcefield::addKToMatrix");
    ...
    sofa::helper::AdvancedTimer::stepEnd("HyperelasticSplineForcefield::addKToMatrix");
}

template <typename Element>
SReal HyperelasticSplineForcefield<Element>::getPotentialEnergy (
    const sofa::core::MechanicalParams* mparams,
    ...
    sofa::helper::AdvancedTimer::stepBegin("HyperelasticSplineForcefield::getPotentialEnergy");
    ...
    sofa::helper::AdvancedTimer::stepEnd("HyperelasticSplineForcefield::getPotentialEnergy");
...
void HyperelasticSplineForcefield<Element>::initialize_elements()
{
    ...
    sofa::helper::AdvancedTimer::stepBegin("HyperelasticSplineForcefield::initialize_elements");
...
template <typename Element>
void HyperelasticSplineForcefield<Element>::assemble_stiffness()
{
    assemble_stiffness(*this->mstate->read (p_X_id.getId(this->mstate)));
}

template<typename Element>
void HyperelasticSplineForcefield<Element>::assemble_stiffness(const sofa::core::objectmodel::Data<VecCoord> & x) {
    using namespace sofa::core::objectmodel;
...
void HyperelasticSplineForcefield<Element>::assemble_stiffness(const Eigen::MatrixBase<Derived> & x) {
    ...
    sofa::helper::AdvancedTimer::stepBegin("HyperelasticSplineForcefield::update_stiffness");
...
#pragma omp critical
    ...
    sofa::helper::AdvancedTimer::stepEnd("HyperelasticSplineForcefield::update_stiffness");
...
template <typename Element>
auto HyperelasticSplineForcefield<Element>::get_gauss_nodes(const std::size_t & /*element_id*/, const Element & element) const -> GaussContainer {
...
template <typename Element>
auto HyperelasticSplineForcefield<Element>::eigenvalues() -> const Vector<Eigen::Dynamic> & {
...
template <typename Element>
auto HyperelasticSplineForcefield<Element>::cond() -> Real {
