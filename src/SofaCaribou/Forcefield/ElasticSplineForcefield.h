...
class ElasticSplineForcefield : public CaribouSplineForcefield<Element> {
public:
    SOFA_CLASS(SOFA_TEMPLATE(ElasticSplineForcefield, Element), SOFA_TEMPLATE(CaribouSplineForcefield, Element));
    ...
    using Link = sofa::core::objectmodel::SingleLink<ElasticSplineForcefield<Element>, ObjectType, sofa::core::objectmodel::BaseLink::FLAG_STRONGLINK>;
