...
public:
    SOFA_CLASS(SOFA_TEMPLATE(CaribouSplineForcefield, Element), SOFA_TEMPLATE(sofa::core::behavior::ForceField, typename SofaVecType<caribou::geometry::traits<Element>::Dimension>::Type));
    ...
    using Link = sofa::core::objectmodel::SingleLink<CaribouSplineForcefield<Element>, ObjectType, sofa::core::objectmodel::BaseLink::FLAG_STRONGLINK>;
    ...
    static auto templateName(const CaribouSplineForcefield<Element>* = nullptr) -> std::string;
