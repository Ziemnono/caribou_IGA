...
//    using NodeIndex = UNSIGNED_INTEGER_TYPE;
    ...
    using ExtractionMatrix = Eigen::Matrix<FLOATING_POINT_TYPE, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>;
    using ElementsExtraction = std::vector<ExtractionMatrix>;
     ...
     */
    SplinePatch() : p_nodes {}, p_weights {}, p_indices{}, p_knotranges{}, p_extraction{} {}
...
//        }
    ...
    explicit SplinePatch(const NodeContainer_t & positions, const WeightsContainer & weights,
        ...
        p_nodes (positions), p_weights(weights), p_indices(indices), p_knotranges(knotrange), p_extraction(extraction)
    { }
    ...
    : p_nodes (other.p_nodes), p_weights (other.p_weights), p_indices(other.p_indices), p_knotranges(other.p_knotranges), p_extraction(other.p_extraction){ }
